...
/**** EXERCICE *****/
var paragrapheElt = document.createElement("p"); // Création d'un élément p
var lienElt = document.createElement("a"); //Création d'un élément a

lienElt.textContent= "liste";
lienElt.href = "https://fr.wikipedia.org/wiki/Liste_des_langages_de_programmation"; // Définition du contenu de a
