...
// Ce que j'ai fait : affiche les options marches mais pas les li
// window.addEventListener("load", function () {
//     for (i=0; i<maisons.length; i++){
//         var optionElts = document.createElement("option");
//         optionElts.value = maisons[i].code;
//         optionElts.textContent = maisons[i].nom;
//         document.getElementById("maison").appendChild(optionElts);
//
//         optionElts.addEventListener("click", function (e){
//                 for (i=0; i<optionElts.length; i++){
//                     console.log(e.target.value);
//                     var listeElts = document.createElement("li");
//                     listeElts.textContent = getPersonnages(optionElts[i].value);
//                     document.getElementById("persos").appendChild(listeElts);
//                     console.log("Bla");
//                 });
//                 console.log(e.target.value);
//     });
